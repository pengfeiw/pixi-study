...
import yellowStar from "../assests/yellowstar.png";
...
const starButton1 = PIXI.Sprite.from(yellowStar);
...
const starButton2 = PIXI.Sprite.from(yellowStar);
...
const starButton3 = PIXI.Sprite.from(yellowStar);
...
const starButton4 = PIXI.Sprite.from(yellowStar);
